...
Functions for satellite data preprocessing
...
Functions for correcting surface reflectance for the effects of
topography
...
Functions for calculating the anisotropic reflection factors for
different spectral bands and surface types (snow or ice)

- [`f_BRDF()`](https://pabl1t0x.github.io/SatRbedo/reference/f_BRDF.md)
  : Anisotropy correction of reflected radiation over melting snow and
  glacier ice
...
Functions for calculating narrowband and broadband albedo from
topographically-corrected surface reflectance
