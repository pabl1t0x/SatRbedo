...
``` {r workflow, echo = FALSE, out.width = "80%", fig.cap = "Fig. 1 Flowchart of the satellite albedo retrieval workflow"}
...
```{r example-anisotropy, fig.dim = c(3, 3), fig.cap = "Fig. 2 Broadband albedo"}
SAA <- 164.8 # solar azimuth angle
SZA <- 48.9 # solar zenith angle
