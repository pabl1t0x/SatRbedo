...
[![name status badge](https://pabl1t0x.r-universe.dev/badges/:name)](https://pabl1t0x.r-universe.dev/)
[![SatRbedo status badge](https://pabl1t0x.r-universe.dev/SatRbedo/badges/version)](https://pabl1t0x.r-universe.dev/SatRbedo)
<!-- badges: end -->
...
``` {r gpl, echo = FALSE, out.width="15%"}
knitr::include_graphics("man/figures/gplv3-127x51.png")
```

## Acknowledgements

Logo designed by [Diego Espinatto](https://www.behance.net/despinatto85).
