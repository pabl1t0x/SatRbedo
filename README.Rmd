...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/pabl1t0x/SatRbedo/graph/badge.svg)](https://app.codecov.io/gh/pabl1t0x/SatRbedo/tree/master)
<!-- badges: end -->
...
knitr::include_graphics("inst/paper/workflow.png")
```
